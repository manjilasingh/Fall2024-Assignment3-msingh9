...
namespace Fall2024_Assignment3_msingh9.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AITweets = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    AIReviews = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AverageSentiment = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
